...
public class SessionManager {
    ...
    public static final String PREFER_NAME = "com.example.adk.adk";
    ...
    public SessionManager(Context context){
        ...
        pref = _context.getSharedPreferences(PREFER_NAME,_context.MODE_PRIVATE);
        editor = pref.edit();
    }

    //Create login session
    public void createUserLoginSession( String uemail){
...
//        editor.putString(KEY_NAME, uName);
    ...
    public void createUserSignupSession(String uName, String uemail){
        // Storing login value as TRUE
        editor.putBoolean(IS_USER_LOGIN, true);
